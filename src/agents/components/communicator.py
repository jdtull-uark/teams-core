...
class Communicator(ABC):
    ...
    def initiate_interaction(self, recipient_agent: 'BaseAgent', interaction_type, details: Dict[str, Any] = None):
        if not details:
            details = {}
    ...
    @abstractmethod
    def process_interaction(self, initiating_agent: 'BaseAgent', interaction_type, details: Dict[str, Any] = None):
        pass
